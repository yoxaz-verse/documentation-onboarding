...
export const MILESTONES: MilestoneDefinition[] = [
  ...
  },
  {
    ...
    shortLabel: 'WhatsApp',
    summary: 'Join the official operator WhatsApp group for coordination, questions, and updates.',
    route: '/step7',
  },
  {
    number: 8,
    ...
    shortLabel: 'Register',
    summary: 'Create your account on the OBAOL operator platform.',
    route: '/step8',
  },
  {
    number: 9,
    slug: 'whatsapp-orientation',
    label: 'WhatsApp Group Orientation',
    shortLabel: 'Group Guide',
    summary: 'Review how to use the operator WhatsApp group clearly and professionally.',
    route: '/step9',
  },
  {
    number: 10,
    slug: 'communication-readiness',
    label: 'Communication Readiness',
    shortLabel: 'Ready Check',
    summary: 'Confirm that you joined the WhatsApp group and reviewed its communication guidelines.',
    route: '/step10',
  },
  {
    number: 11,
