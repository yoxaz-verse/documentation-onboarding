...
export type JourneyScenarioQuestion = {
  id: string;
  title: string;
  situation: string;
  question: string;
...
export type JourneyDayTemplate = JourneyMilestone & {
  ...
  scenarioQuestions?: JourneyScenarioQuestion[];
...
export const JOURNEY_CHECKS: JourneyCheck[] = [
  ...
  },
  {
    ...
    description: 'Confirm you are ready to use the training library alongside your operator journey levels.',
  },
];
...
const daySeeds: DaySeed[] = [
  {
    ...
    category: 'setup',
    dayType: 'Setup',
    purpose: 'The operator must understand where the workspace, journey tracker, profile, courses, and level tasks are located before outreach begins.',
    learn: ['Operator dashboard location', 'Onboarding and level completion tracking', 'Course library and profile locations', 'Where supplier, buyer, product, availability, and requirement entries will be added'],
    tasks: [
      {
        title: 'Open the operator dashboard',
        instruction: 'Review the dashboard navigation and identify where your onboarding progress, journey work, courses, profile, and operator tools are located.',
        href: '/',
      ...
      },
      {
        ...
        instruction: 'Review where your training tracks and lessons are located so you can return to them during the 30-level journey.',
        href: '/courses',
        actionLabel: 'Open course library',
      },
      {
        title: 'Review the 30-level journey',
        instruction: 'Understand how level guides, required outputs, submissions, reviews, and locked future levels work on this page.',
        href: '/journey',
    ...
    completionMessage: 'Your operator journey has started. From Level 2 onward, you will begin understanding the OBAOL execution model and your role inside the system.',
    formFields: [
      ...
      baseField('journeyPageOpened', 'I reviewed the 30-level journey workflow', 'select', true, ['Yes']),
  ...
  },
  {
    ...
    learn: ['Use FCA when the seller loads at its premises and clears exports', 'Distinguish FAS vessel-side delivery from FOB on-board delivery', 'Separate seller-paid carriage from the earlier risk-transfer point under C rules', 'Recognize DPU as the destination rule requiring seller unloading', 'Distinguish buyer import clearance under DAP from seller import responsibility under DDP'],
    tasks: [
      {
      ...
      { title: 'Read each shipment carefully', instruction: 'Identify the transport method, delivery point, loading or unloading duty, customs responsibility, carriage, insurance, and risk-transfer point.' },
      { title: 'Pass the scenario checkpoint', instruction: 'Answer all five scenarios and score at least 4 out of 5. Incorrect answers can be reviewed and retried immediately.' },
    ],
    requiredOutput: 'Five completed Incoterms® scenarios with a score of at least 4/5.',
    buttonText: 'Submit Incoterms Scenarios',
    completionMessage: 'Level 4 complete. You can now apply core Incoterms® 2020 principles to practical shipment scenarios.',
    formFields: [],
    repeatGroups: [],
    scenarioPassScore: 4,
    scenarioQuestions: [
  ...
  },
  {
    ...
    completionMessage: 'Your product circle is now selected. From the next level onward, your learning and outreach will become more focused.',
    formFields: [
...
export const JOURNEY_PAGE_COPY = {
  title: '30-Level Operator Execution Path',
  ...
  description:
    'This 30-level path helps operators build trade understanding, supplier-buyer data, quotation speed, relationship discipline, and cluster collaboration. The goal is not to depend on one inquiry, but to build continuous market momentum inside the OBAOL execution system.',
  finalRule:
...
export const JOURNEY_MILESTONES: JourneyMilestone[] = [
  {
    ...
    day: 1,
    title: 'Start your operator level path',
  ...
  },
  {
    ...
    day: 30,
    title: 'Complete 30-level operator review',
